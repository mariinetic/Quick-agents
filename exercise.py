"""
SOLUTION: Groq Model Switching Exercise - LangChain Integration
 
This is the complete solution for the langchain-groq integration exercise.
Students should implement the "implement_" functions in their exercise.py file.
 
Note: This demonstrates proper langchain-groq integration patterns using mock objects.
In real projects, you would use: from langchain_groq import ChatGroq
"""
